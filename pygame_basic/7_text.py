...
# 폰트정의
game_font = pygame.font.Font(None, 40) # 폰트객체를 생성하고 폰트와 크기를 지정
# 총 시간
total_time = 10

# 시작 시간
strat_ticks = pygame.time.get_ticks() # 시작 tick을 받아옴
...
while running :
    ...
    elapsed_time = (pygame.time.get_ticks()- strat_ticks) / 1000 # 경과시간을 1000으로 나누어 초단위로 표시
    timer = game_font.render(str(int(total_time - elapsed_time)), True, (255,255,255)) # render에 들어가는 값들은 시간, True ,글자 색상
